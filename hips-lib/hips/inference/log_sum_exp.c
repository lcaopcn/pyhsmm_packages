...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "hips.inference.log_sum_exp", 
        "sources": [
            "hips/inference/log_sum_exp.pyx"
        ]
    }, 
    "module_name": "hips.inference.log_sum_exp"
}
END: Cython Metadata */
...
#define __PYX_HAVE__hips__inference__log_sum_exp
#define __PYX_HAVE_API__hips__inference__log_sum_exp
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'hips.inference.log_sum_exp' */
...
static double __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_normalize(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_sample(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_4hips_9inference_11log_sum_exp_discrete_sample(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "hips.inference.log_sum_exp"
extern int __pyx_module_is_main_hips__inference__log_sum_exp;
int __pyx_module_is_main_hips__inference__log_sum_exp = 0;

/* Implementation of 'hips.inference.log_sum_exp' */
...
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_log_sum_exp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp); /* proto */
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_2log_sum_exp_normalize(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp, __Pyx_memviewslice __pyx_v_p); /* proto */
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_4log_sum_exp_sample(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp); /* proto */
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_6discrete_sample(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_p); /* proto */
...
/* "hips/inference/log_sum_exp.pyx":12
 * 
...
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_1log_sum_exp(PyObject *__pyx_self, PyObject *__pyx_arg_lnp); /*proto*/
static double __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp(__Pyx_memviewslice __pyx_v_lnp, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_n;
  double __pyx_v_max_lnp;
  ...
  /* "hips/inference/log_sum_exp.pyx":20
 *     # lnp = np.ravel(lnp)
 *     # N = np.size(lnp)
 ...
 */
  __pyx_v_N = (__pyx_v_lnp.shape[0]);

  /* "hips/inference/log_sum_exp.pyx":23
 *     cdef int n
 *     # Use logsumexp trick to calculate ln(p1 + p2 + ... + pR) from ln(pi)'s
 ...
 */
  ...
  __pyx_t_1 = PyNumber_Negative(__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_max_lnp = __pyx_t_3;

  /* "hips/inference/log_sum_exp.pyx":24
 *     # Use logsumexp trick to calculate ln(p1 + p2 + ... + pR) from ln(pi)'s
 *     cdef double max_lnp = -np.Inf
 *     for n in range(N):             # <<<<<<<<<<<<<<
 *         if lnp[n] > max_lnp:
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "hips/inference/log_sum_exp.pyx":25
 *     cdef double max_lnp = -np.Inf
 *     for n in range(N):
 *         if lnp[n] > max_lnp:             # <<<<<<<<<<<<<<
 *             max_lnp = lnp[n]
 ...
 */
    __pyx_t_7 = __pyx_v_n;
    __pyx_t_8 = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_lnp.data) + __pyx_t_7)) ))) > __pyx_v_max_lnp) != 0);
    if (__pyx_t_8) {

      /* "hips/inference/log_sum_exp.pyx":26
 *     for n in range(N):
 *         if lnp[n] > max_lnp:
 *             max_lnp = lnp[n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_9 = __pyx_v_n;
      __pyx_v_max_lnp = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_lnp.data) + __pyx_t_9)) )));
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":29
 * 
 *     # Sum up the terms, subtracting off max lnp
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":30
 *     # Sum up the terms, subtracting off max lnp
 *     cdef double sum_exp = 0
 *     for n in range(N):             # <<<<<<<<<<<<<<
 *         sum_exp += exp(lnp[n]-max_lnp)
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "hips/inference/log_sum_exp.pyx":31
 *     cdef double sum_exp = 0
 *     for n in range(N):
 *         sum_exp += exp(lnp[n]-max_lnp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_sum_exp = (__pyx_v_sum_exp + exp(((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_lnp.data) + __pyx_t_10)) ))) - __pyx_v_max_lnp)));
  }

  /* "hips/inference/log_sum_exp.pyx":33
 *         sum_exp += exp(lnp[n]-max_lnp)
 * 
 *     return log(sum_exp) + max_lnp             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_r = (log(__pyx_v_sum_exp) + __pyx_v_max_lnp);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("hips.inference.log_sum_exp.log_sum_exp", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_1log_sum_exp(PyObject *__pyx_self, PyObject *__pyx_arg_lnp); /*proto*/
static char __pyx_doc_4hips_9inference_11log_sum_exp_log_sum_exp[] = "\n    Sample uniformly from a vector of unnormalized log probs using \n    the log-sum-exp trick\n    ";
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_1log_sum_exp(PyObject *__pyx_self, PyObject *__pyx_arg_lnp) {
  __Pyx_memviewslice __pyx_v_lnp = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("log_sum_exp (wrapper)", 0);
  assert(__pyx_arg_lnp); {
    __pyx_v_lnp = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_arg_lnp, PyBUF_WRITABLE); if (unlikely(!__pyx_v_lnp.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("hips.inference.log_sum_exp.log_sum_exp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4hips_9inference_11log_sum_exp_log_sum_exp(__pyx_self, __pyx_v_lnp);
...
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_log_sum_exp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("log_sum_exp", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_lnp.memview)) { __Pyx_RaiseUnboundLocalError("lnp"); __PYX_ERR(0, 12, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp(__pyx_v_lnp, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_lnp, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "hips/inference/log_sum_exp.pyx":35
 *     return log(sum_exp) + max_lnp
 * 
 * cpdef log_sum_exp_normalize(double[::1] lnp, double[::1] p):             # <<<<<<<<<<<<<<
 *     cdef int N = lnp.shape[0]
...
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_3log_sum_exp_normalize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_normalize(__Pyx_memviewslice __pyx_v_lnp, __Pyx_memviewslice __pyx_v_p, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  ...
  __Pyx_RefNannySetupContext("log_sum_exp_normalize", 0);

  /* "hips/inference/log_sum_exp.pyx":36
 * 
 * cpdef log_sum_exp_normalize(double[::1] lnp, double[::1] p):
 *     cdef int N = lnp.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double denom = log_sum_exp(lnp)
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":37
 * cpdef log_sum_exp_normalize(double[::1] lnp, double[::1] p):
 *     cdef int N = lnp.shape[0]
 *     cdef double denom = log_sum_exp(lnp)             # <<<<<<<<<<<<<<
 *     cdef int n
 * 
 */
  __pyx_v_denom = __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp(__pyx_v_lnp, 0);

  /* "hips/inference/log_sum_exp.pyx":40
 *     cdef int n
 * 
 *     for n in range(N):             # <<<<<<<<<<<<<<
 *         p[n] = exp(lnp[n] - denom)
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "hips/inference/log_sum_exp.pyx":41
 * 
 *     for n in range(N):
 *         p[n] = exp(lnp[n] - denom)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = __pyx_v_n;
    __pyx_t_5 = __pyx_v_n;
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_p.data) + __pyx_t_5)) )) = exp(((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_lnp.data) + __pyx_t_4)) ))) - __pyx_v_denom));
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_3log_sum_exp_normalize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_3log_sum_exp_normalize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_lnp = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_p = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("log_sum_exp_normalize (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lnp,&__pyx_n_s_p,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lnp)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_p)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("log_sum_exp_normalize", 1, 2, 2, 1); __PYX_ERR(0, 35, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "log_sum_exp_normalize") < 0)) __PYX_ERR(0, 35, __pyx_L3_error)
      }
    ...
    __pyx_v_lnp = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_lnp.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
    __pyx_v_p = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_p.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("log_sum_exp_normalize", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 35, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hips.inference.log_sum_exp.log_sum_exp_normalize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4hips_9inference_11log_sum_exp_2log_sum_exp_normalize(__pyx_self, __pyx_v_lnp, __pyx_v_p);
...
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_2log_sum_exp_normalize(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp, __Pyx_memviewslice __pyx_v_p) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("log_sum_exp_normalize", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_lnp.memview)) { __Pyx_RaiseUnboundLocalError("lnp"); __PYX_ERR(0, 35, __pyx_L1_error) }
  if (unlikely(!__pyx_v_p.memview)) { __Pyx_RaiseUnboundLocalError("p"); __PYX_ERR(0, 35, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_normalize(__pyx_v_lnp, __pyx_v_p, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "hips/inference/log_sum_exp.pyx":44
 * 
 * 
...
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_5log_sum_exp_sample(PyObject *__pyx_self, PyObject *__pyx_arg_lnp); /*proto*/
static int __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_sample(__Pyx_memviewslice __pyx_v_lnp, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  __Pyx_memviewslice __pyx_v_p = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("log_sum_exp_sample", 0);

  /* "hips/inference/log_sum_exp.pyx":45
 * 
 * cpdef int log_sum_exp_sample(double[::1] lnp):
 *     cdef int N = lnp.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int n
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":48
 *     cdef int n
 * 
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_p = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "hips/inference/log_sum_exp.pyx":49
 * 
 *     cdef double[::1] p = np.zeros(N,)
 *     log_sum_exp_normalize(lnp, p)             # <<<<<<<<<<<<<<
 *     return discrete_sample(p)
 * 
 */
  __pyx_t_1 = __pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_normalize(__pyx_v_lnp, __pyx_v_p, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "hips/inference/log_sum_exp.pyx":50
 *     cdef double[::1] p = np.zeros(N,)
 *     log_sum_exp_normalize(lnp, p)
 *     return discrete_sample(p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_r = __pyx_f_4hips_9inference_11log_sum_exp_discrete_sample(__pyx_v_p, 0);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("hips.inference.log_sum_exp.log_sum_exp_sample", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_p, 1);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_5log_sum_exp_sample(PyObject *__pyx_self, PyObject *__pyx_arg_lnp); /*proto*/
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_5log_sum_exp_sample(PyObject *__pyx_self, PyObject *__pyx_arg_lnp) {
  __Pyx_memviewslice __pyx_v_lnp = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("log_sum_exp_sample (wrapper)", 0);
  assert(__pyx_arg_lnp); {
    __pyx_v_lnp = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_arg_lnp, PyBUF_WRITABLE); if (unlikely(!__pyx_v_lnp.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("hips.inference.log_sum_exp.log_sum_exp_sample", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4hips_9inference_11log_sum_exp_4log_sum_exp_sample(__pyx_self, __pyx_v_lnp);
...
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_4log_sum_exp_sample(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lnp) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("log_sum_exp_sample", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_lnp.memview)) { __Pyx_RaiseUnboundLocalError("lnp"); __PYX_ERR(0, 44, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4hips_9inference_11log_sum_exp_log_sum_exp_sample(__pyx_v_lnp, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "hips/inference/log_sum_exp.pyx":52
 *     return discrete_sample(p)
 * 
 * cpdef int discrete_sample(double[::1] p):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_7discrete_sample(PyObject *__pyx_self, PyObject *__pyx_arg_p); /*proto*/
static int __pyx_f_4hips_9inference_11log_sum_exp_discrete_sample(__Pyx_memviewslice __pyx_v_p, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_choice;
  double __pyx_v_u;
  double __pyx_v_acc;
  ...
  int __pyx_t_9;
  __Pyx_RefNannySetupContext("discrete_sample", 0);

  /* "hips/inference/log_sum_exp.pyx":54
 * cpdef int discrete_sample(double[::1] p):
 *     # Randomly sample from p
 *     cdef int N = p.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int choice = -1
 ...
 */
  __pyx_v_N = (__pyx_v_p.shape[0]);

  /* "hips/inference/log_sum_exp.pyx":55
 *     # Randomly sample from p
 *     cdef int N = p.shape[0]
 *     cdef int choice = -1             # <<<<<<<<<<<<<<
 *     cdef double u = np.random.rand()
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":56
 *     cdef int N = p.shape[0]
 *     cdef int choice = -1
 *     cdef double u = np.random.rand()             # <<<<<<<<<<<<<<
 *     cdef double acc = 0.0
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":57
 *     cdef int choice = -1
 *     cdef double u = np.random.rand()
 *     cdef double acc = 0.0             # <<<<<<<<<<<<<<
 *     for n in range(N):
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":58
 *     cdef double u = np.random.rand()
 *     cdef double acc = 0.0
 *     for n in range(N):             # <<<<<<<<<<<<<<
 *         acc += p[n]
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "hips/inference/log_sum_exp.pyx":59
 *     cdef double acc = 0.0
 *     for n in range(N):
 *         acc += p[n]             # <<<<<<<<<<<<<<
 *         if u <= acc:
 ...
 */
    __pyx_t_8 = __pyx_v_n;
    __pyx_v_acc = (__pyx_v_acc + (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_p.data) + __pyx_t_8)) ))));

    /* "hips/inference/log_sum_exp.pyx":60
 *     for n in range(N):
 *         acc += p[n]
 *         if u <= acc:             # <<<<<<<<<<<<<<
 *             choice = n
 *             break
 */
    __pyx_t_9 = ((__pyx_v_u <= __pyx_v_acc) != 0);
    if (__pyx_t_9) {

      /* "hips/inference/log_sum_exp.pyx":61
 *         acc += p[n]
 *         if u <= acc:
 *             choice = n             # <<<<<<<<<<<<<<
 *             break
 * 
 */
      __pyx_v_choice = __pyx_v_n;

      /* "hips/inference/log_sum_exp.pyx":62
 *         if u <= acc:
 *             choice = n
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":64
 *             break
 * 
 *     return choice             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_WriteUnraisable("hips.inference.log_sum_exp.discrete_sample", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_7discrete_sample(PyObject *__pyx_self, PyObject *__pyx_arg_p); /*proto*/
static PyObject *__pyx_pw_4hips_9inference_11log_sum_exp_7discrete_sample(PyObject *__pyx_self, PyObject *__pyx_arg_p) {
  __Pyx_memviewslice __pyx_v_p = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("discrete_sample (wrapper)", 0);
  assert(__pyx_arg_p); {
    __pyx_v_p = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_arg_p, PyBUF_WRITABLE); if (unlikely(!__pyx_v_p.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("hips.inference.log_sum_exp.discrete_sample", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4hips_9inference_11log_sum_exp_6discrete_sample(__pyx_self, __pyx_v_p);
...
static PyObject *__pyx_pf_4hips_9inference_11log_sum_exp_6discrete_sample(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_p) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("discrete_sample", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_p.memview)) { __Pyx_RaiseUnboundLocalError("p"); __PYX_ERR(0, 52, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4hips_9inference_11log_sum_exp_discrete_sample(__pyx_v_p, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "hips.inference.log_sum_exp.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "hips.inference.log_sum_exp.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "hips.inference.log_sum_exp.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hips.inference.log_sum_exp._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"log_sum_exp", (PyCFunction)__pyx_pw_4hips_9inference_11log_sum_exp_1log_sum_exp, METH_O, __pyx_doc_4hips_9inference_11log_sum_exp_log_sum_exp},
  {"log_sum_exp_normalize", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4hips_9inference_11log_sum_exp_3log_sum_exp_normalize, METH_VARARGS|METH_KEYWORDS, 0},
  {"log_sum_exp_sample", (PyCFunction)__pyx_pw_4hips_9inference_11log_sum_exp_5log_sum_exp_sample, METH_O, 0},
  {"discrete_sample", (PyCFunction)__pyx_pw_4hips_9inference_11log_sum_exp_7discrete_sample, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_log_sum_exp(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_log_sum_exp},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlog_sum_exp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlog_sum_exp(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_log_sum_exp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_log_sum_exp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_log_sum_exp(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'log_sum_exp' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_log_sum_exp(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("log_sum_exp", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_hips__inference__log_sum_exp) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hips.inference.log_sum_exp")) {
      if (unlikely(PyDict_SetItemString(modules, "hips.inference.log_sum_exp", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "hips/inference/log_sum_exp.pyx":8
 * ## cython: profile=True
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "hips/inference/log_sum_exp.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hips.inference.log_sum_exp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init hips.inference.log_sum_exp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
